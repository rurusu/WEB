<%@ Page Title="下載 - " Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Android.aspx.cs" Inherits="Android" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
	...
	<div class="row">
		...
		<div class="col-md-8">
			<img src="../image/download_google.png" width="200px" />
		</div>
	</div>
    </div>
</asp:Content>
